...
public class CommandTestUtil {
    ...
    public static final String INVALID_MOD = "CS12@4";

    public static final String VALID_NAME_AMY = "Amy Bee";
    public static final String VALID_NAME_BOB = "Bob Choo";
    public static final String VALID_EMAIL_AMY = "amy@example.com";
    public static final String VALID_EMAIL_BOB = "bob@example.com";
    public static final String VALID_MODTUT_HUSBAND = "CS2109-T09";
    public static final String VALID_MODTUT_FRIEND = "CS2103T-T01";
    public static final String VALID_TELE_AMY = "@amybee";
    ...
    public static final String VALID_MOD_AMY = "CS1234";
    public static final String VALID_MOD_BOB = "ES2666";
    public static final String VALID_TAG_HUSBAND = "husband";
    public static final String VALID_TAG_FRIEND = "friend";

    public static final String NAME_DESC_AMY = " " + PREFIX_NAME + VALID_NAME_AMY;
    public static final String NAME_DESC_BOB = " " + PREFIX_NAME + VALID_NAME_BOB;
    public static final String TELE_DESC_AMY = " " + PREFIX_TELEGRAM + VALID_TELE_AMY;
