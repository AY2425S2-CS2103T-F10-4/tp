...
public class ParserUtilTest {
    ...
    private static final String INVALID_MOD = "CS21@8";
    ...
    public void parseModule_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtil.parseMod((String) null));
    }
    ...
    public void parseModule_validValueWithoutWhitespace_returnsModule() throws Exception {
        Module expectedModule = new Module(VALID_MOD);
        assertEquals(expectedModule, ParserUtil.parseMod(VALID_MOD));
    }

    @Test
    public void parseModule_validValueWithWhitespace_returnsTrimmedModule() throws Exception {
        String moduleWithWhitespace = WHITESPACE + VALID_MOD + WHITESPACE;
        Module expectedModule = new Module(VALID_MOD);
        assertEquals(expectedModule, ParserUtil.parseMod(moduleWithWhitespace));
    }
