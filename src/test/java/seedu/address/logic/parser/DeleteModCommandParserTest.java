...
import static seedu.address.logic.commands.CommandTestUtil.INVALID_MOD;
...
public class DeleteModCommandParserTest {
    ...
    public void parse_invalidArgs_throwsParseException() {
        assertParseFailure(parser, INVALID_MOD, String.format(MESSAGE_INVALID_COMMAND_FORMAT, DeleteModCommand.MESSAGE_USAGE));
    }
}
